def font_transform(filename : str):
    ...
    if not (fn_noext + ".c\n") in fonts_linked:
        ...
        code_file : IO = open("src/fonts/" + fn_noext + ".c", "w")
        ...
        with open(".gitignore", "w") as gitignore:
            ...
            gitignore.write("src/fonts/" + fn_noext + ".c\n")

        fonts_h_dump = str()
        try:
            with open("src/fonts/fonts.h", "r") as fonts_h:
                fonts_h_dump = fonts_h.read()
        except:
            fonts_h_dump = ""
        with open("src/fonts/fonts.h", "w") as fonts_h:
